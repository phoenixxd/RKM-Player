...
public class Splashscreen extends Activity {
    ...
    private void StartAnimations() {
        ...
        anim.reset();   //Reset the initialization state of this animation.
            ...
            public void run() {
                try {
                    ...
                    Intent intent = new Intent(Splashscreen.this,
                            MainList.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION); //prevents the system from applying an activity transition
