...
public class MemoryCache2 extends BaseAdapter {
    ...
    public MemoryCache2(Context context, ArrayList<String> items) {
        ...
        final int cacheSize = (int)(maxMemory * percentage / 100.0);
    ...
    public void loadBitmap(int resId, ImageView imageView) {
        if (cancelPotentialWork(resId, imageView)) {
            ...
            imageView.setBackgroundResource(R.drawable.musi);
            task.execute(resId);
        }
    }
